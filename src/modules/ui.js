export const renderUI = (patient) => {
  ...
  const femaleIcon = `
    <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" id="female-icon" viewBox="0 0 42 42">
  ...
  `;
  const maleIcon = `
    <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" id="male-icon" viewBox="0 0 42 42">
  ...
  const patientProfile = `
    ...
    <div id="more-info">
      <div id="dob">
        <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" id="birth-icon" viewBox="0 0 42 42">
      ...
      <div id="contact-info">
      <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" class="phone-icon" viewBox="0 0 42 42">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" id="insurance-icon" viewBox="0 0 42 42">
  ...
  genderIcon.innerHTML = gender === 'Female' ? femaleIcon : maleIcon;
